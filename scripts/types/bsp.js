...
/**
* Decode all textures as images and add them to the current page.
* @param {PAL} palette - The palette file to use for image decoding.
*/
QuakeWebTools.BSP.prototype.generateHTMLPreview = function(palette) {
    var fragment = new DocumentFragment();
    var IU = QuakeWebTools.ImageUtil;

    for (var i = 0; i < this.miptex_directory.length; ++i) {
